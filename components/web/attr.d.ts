...
declare global {
    namespace CAttr {
        interface Ref extends CDivElement.Ref, IconAttr, FlexAttr, GridAttr, BlockAttr, ThemeColorAttr, ThemeSizeAttr {
        }
        type Key = keyof Omit<CAttr.Ref, keyof HTMLAttributes<CAttr.Ref> | keyof ClassAttributes<CAttr.Ref>>;
    }
    namespace JSX {
